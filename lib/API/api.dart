...
class DataFetcher {
  ...
  Future<void> fetchData() async {
      ...
      if (cash_helper ==null) {
        ...
        try {
          createdatabase.DataBaseInfo();
           Map CurrencyInfo =await currencyApi.fetchLatestRates();
            CurrencyInfo['data'].forEach((key, value) =>insert.insertdata(key, createdatabase.database));
        ...
        createdatabase.DataBaseInfo().then((value) => getData.getdata(createdatabase.database));
      }
